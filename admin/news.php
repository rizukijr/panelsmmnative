            ...
            <div class="content-page">
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
								<a href="<?php echo $cfg_baseurl; ?>admin/news/add" class="btn btn-info m-b-20"><i class="fa fa-plus"></i> Tambah Berita </a>
								<div class="panel panel-color panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="mdi mdi-bell-outline"></i> Kelola Berita</h3>
                                    </div>
