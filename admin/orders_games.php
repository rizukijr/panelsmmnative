...
if (isset($_SESSION['user'])) {
	...
	// widget
	$check_worder = mysqli_query($db, "SELECT SUM(price) AS total FROM orders_dm");
	$data_worder = mysqli_fetch_assoc($check_worder);
	$check_worder = mysqli_query($db, "SELECT * FROM orders_dm");
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT * FROM orders_dm WHERE oid LIKE '%$search%' ORDER BY id DESC"; // edit
} else {
	$query_list = "SELECT * FROM orders_dm ORDER BY id DESC"; // edit
}
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/order_games/edit.php?oid=<?php echo $data_show['oid']; ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
														</td>
													</tr>
												<?php
												}
