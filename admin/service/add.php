                            ...
                            <div class="col-md-12">
                                <div class="panel panel-color panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="mdi mdi-cards-outline"></i> Tambah Layanan</h3>
                                    </div>
                                    <div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/services" class="btn btn-default waves-effect w-md waves-light">Kembali</a>
											    </div>
										    </div>
										</form>
									</div>
