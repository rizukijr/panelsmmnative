...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_GET['sid'])) {
			$post_sid = $_GET['sid'];
			$check_target = mysqli_query($db, "SELECT * FROM services_game WHERE sid = '$post_sid'");
                                    ...
                                    <div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover m-0">
												...
												<tr>
													<th>Category</th>
													<td><?php echo $data_target['category']; ?></td>
												</tr>
												<tr>
													<th>Price</th>
												...
												<tr>
													<th>Paket</th>
													<td><?php echo $data_target['paket']; ?></td>
												</tr>
												<tr>
													<th>Provider Code</th>
										...
										<a href="<?php echo $cfg_baseurl; ?>admin/services_game.php" class="btn btn-info m-t-20">Kembali ke daftar</a>
									</div>
								</div>
							</div>
						</div>
