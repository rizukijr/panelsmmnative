	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['delete'])) {
			...
			if (mysqli_num_rows($checkdb_service) == 0) {
				...
				$delete_user = mysqli_query($db, "DELETE FROM services_game WHERE sid = '$post_sid'");
				if ($delete_user == TRUE) {
					$msg_type = "success";
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-color panel-info">
                                    ...
                                    <div class="panel-body">
										...
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/service_game/add.php" class="btn btn-info"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT * FROM services_game WHERE services_game LIKE '%$search%' ORDER BY sid ASC"; // edit
} else {
	$query_list = "SELECT * FROM services_game ORDER BY sid ASC"; // edit
}
...
// end paging config
												...
												?>
													<tr>
														...
														<td><?php echo $data_show['paket']; ?></td>
														<td><?php echo $data_show['provider']; ?></td>
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/service_game/detail.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service_game/edit.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service_game/delete.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
