                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Kelola Riwayat Transfer</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card-box widget-box-three">
                                    ...
                                    <div class="text-right">
                                        <p class="text-success m-t-5 text-uppercase font-600 font-secondary">Total Seluruh Transfer Saldo</p>
                                        <h2 class="m-b-10"><span data-plugin="">Rp <?php echo number_format($data_wtransfer['total'],0,',','.'); ?></span></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-color panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="ti ti-shopping-cart"></i> Daftar Riwayat</h3>
                                    </div>
