...
// setting price 
 $check_services = mysqli_query($db, "SELECT * FROM services WHERE pid = '$id' AND provider='MP-SOSMED'");
...
$insert=mysqli_query($db, "INSERT INTO services (sid,category,service,note, min, max, price, status, pid, provider) VALUES ('$id','$category','$service','$note','$min_order','$max_order','$rate_asli','Active','$id','MEDANPEDIA')");//Memasukan Kepada Database (OPTIONAL)
if($insert == TRUE){
