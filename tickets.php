...
if (isset($_SESSION['user'])) {
	...
	if (isset($_POST['submit'])) {
		...
		if (empty($post_subject) || empty($post_message)) {
			...
			$insert_ticket = mysqli_query($db, "INSERT INTO tickets (id, user, subject, message, datetime, last_update, status) VALUES ('$id', '$sess_username', '$post_subject', '$post_message', '$date $time', '$date $time', 'Pending')");
